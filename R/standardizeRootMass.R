#' @title Standardize NEON root dry mass data to current size and root status categories
...
#'
#' @param inputMass The 'bbc_rootmass' table for the site x month combination(s) of interest (defaults to NA). If table input is provided, the 'inputDataList' argument must be omitted. [data.frame]
#'
