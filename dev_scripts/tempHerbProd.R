...
### Check 2019 function output for all sites
tempHBP <- neonUtilities::loadByProduct(dpID = "DP1.10023.001",
                                        site = "all",
                                        startdate = "2019-01",
                                        enddate = "2019-12",
...
#   Problems and oddities:
#--> Potentially no issues?



### Check 2018 function output for all sites
tempHBP <- neonUtilities::loadByProduct(dpID = "DP1.10023.001",
                                        site = "all",
                                        startdate = "2018-01",
                                        enddate = "2018-12",
...
#   Problems and oddities:
#--> Nothing jumps out as a problem; odd that WOOD seems to be grazed but only 1 bout



### Check 2017 function output for all sites
tempHBP <- neonUtilities::loadByProduct(dpID = "DP1.10023.001",
                                        site = "all",
                                        startdate = "2017-01",
                                        enddate = "2017-12",
...
#--> Problem: LAJA, MOAB, SJER (all grazed) return > 1 row in site output table
      #--> exclosure = NA but with mass a problem at SJER --> single record with ambiguous exclosure = NA
      #--> plotManagement = NA also in the data for all three of these sites; maybe just missing in some older data? --> yes, fixed logic dealing with plotManagemnet.
#--> all issues addressed, output sensible.
