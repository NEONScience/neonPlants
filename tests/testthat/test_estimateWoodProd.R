...
#   Test that inputDataList object contains required tables (expect 2 tables: vst_agb_kg", "vst_plot_w_0s")
testthat::test_that(desc = "Required tables present in inputDataList object", {
  testthat::expect_error(object = estimateWoodProd(inputDataList = estimateWoodMassOutputs[2]),
