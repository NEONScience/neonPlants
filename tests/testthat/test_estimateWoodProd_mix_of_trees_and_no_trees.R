...
estimateWoodProdOutputs <- estimateWoodProd(inputDataList = VstDat, plotSubset = "towerAll", siteID = "BLAN")

### Test: Function generates expected output type
testthat::test_that(desc = "Output type", {
  testthat::expect_type(object = estimateWoodProd(inputDataList = VstDat, plotSubset = "towerAll", siteID = "BLAN"),
                        type = "list")
})
...
testthat::test_that(desc = "Output vst_ANPP_plot value as expected", {
  test <- estimateWoodProd(inputDataList = VstDat, plotSubset = "towerAll", siteID = "BLAN")
