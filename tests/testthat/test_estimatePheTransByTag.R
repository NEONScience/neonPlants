...
testthat::test_that("Input tables from list contain required fields ", {
  ...
  testthat::expect_error(object = estimatePheTransByTag(inputDataList = testList_2),
...
##  Test: Function generates expected output classes
#   Test list input
testthat::test_that(desc = "Output class list input", {

  testthat::expect_s3_class(object = testtrans$phe_transition_tag,
                            class = "data.frame")
})
...
testthat::test_that(desc = "Output class table input", {
  ...
  testthat::expect_s3_class(object = testtransti$phe_transition_tag,
                            class = "data.frame")
})
